...
$$\mathbf{T}(0,1) = \mathbf{T}(0,0) + E(s^x(I_{4 \times 4})) = E(s^x(I_{4 \times 4})) \\ \mathbf{T}(1,0) = \mathbf{T}(0,0) + E(s^y(I_{4 \times 4})) = E(s^y(I_{4 \times 4}))$$

since for the base case $\mathbf{T}(0,0) = 0$.

Similarly, we can traverse the recursion tree for $\mathbf{T}(2,0)$ as shown below:
<div class="fig figcenter fighighlight">
